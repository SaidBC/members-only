...
const SQL = `
CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,username TEXT,email TEXT,firstname TEXT,lastname TEXT,password TEXT,role TEXT DEFAULT 'user');
